    ...
    public int encodeFirstName(String firstName,String middleInitial) throws MissingNameException {
        ...
        if(firstNameCodeMap.containsKey(firstName.toUpperCase())) {
            if (middleInitial.length() == 0) {
                return firstNameCodeMap.get(firstName.toUpperCase());
            } else {
                return firstNameCodeMap.get(firstName.toUpperCase()) + middleInitialCodeMap.get(middleInitial.toUpperCase());
            }
        } else {
            if (middleInitial.length() == 0) {
                return firstInitialCodeMap.get(firstName.substring(0, 1).toUpperCase());
            } else {
                return firstInitialCodeMap.get(firstName.substring(0, 1).toUpperCase()) + middleInitialCodeMap.get(middleInitial.toUpperCase());
            }
        }
    }
